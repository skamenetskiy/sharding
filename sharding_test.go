...
func Test_cluster_AllShards(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := c.AllShards(); !reflect.DeepEqual(got, tt.want) {
...
func Test_cluster_Shard(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := c.Shard(tt.args.id).ID(); !reflect.DeepEqual(got, tt.want) {
...
//		want bool
//	}{
//		{"int64", "in64", args{int64Id: 123}, true},
//		{"uint64", "uin64", args{uint64Id: 123}, true},
//		{"string", "string", args{stringId: "123"}, true},
//	}
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			switch tt.t {
//			case "int64":
//				if got := isValidID(tt.args.int64Id); got != tt.want {
//					t.Errorf("isValidID() = %v, want %v", got, tt.want)
//				}
//			case "uint64":
//				if got := isValidID(tt.args.uint64Id); got != tt.want {
//					t.Errorf("isValidID() = %v, want %v", got, tt.want)
//				}
//			case "string":
//				if got := isValidID(tt.args.stringId); got != tt.want {
//					t.Errorf("isValidID() = %v, want %v", got, tt.want)
//				}
//			}
//		})
